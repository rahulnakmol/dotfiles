...
Enterprise architecture practice, multi-cloud across Azure and GCP. This file is the always-loaded spine. Stack-specific and path-scoped rules live in `.claude/rules/` and load when Claude touches matching files. See `.claude/rules/README.md` for the map.
