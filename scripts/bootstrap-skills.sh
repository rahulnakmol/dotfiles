...
# XDG default rather than macOS's ~/Developer/GitHub/skills — override with
# SKILLS_REPO if you keep it somewhere else.
SKILLS_REPO="${SKILLS_REPO:-${XDG_DATA_HOME:-$HOME/.local/share}/skills}"
